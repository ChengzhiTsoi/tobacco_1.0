...
for template in template_list:
    ...
    a_vector = np.asarray(list(map(float, [tf[3], tf[4], tf[5]])))
    b_vector = np.asarray(list(map(float, [tf[6], tf[7], tf[8]])))
    c_vector = np.asarray(list(map(float, [tf[9], tf[10],tf[11]])))
    ...
    if types_vertices == 1  and types_edges == 1 :
       ...
       v_one_coord =  np.asarray(list(map(float,(vertex_one_coord))))
       ...
       e_one_coord = np.asarray(list(map(float,(edge_one_coord))))
    ...
    if types_vertices == 2 and types_edges == 1 :
       ...
       v_two_coord = np.asarray(list(map(float, (vertex_two_coord))))
    ...
    if types_vertices == 2 and types_edges == 2 :
       ...
       e_two_coord = np.asarray(list(map(float, (edge_two_coord))))
